  ...
  <Modal :show="show" @close="close">
    ...
    <template #body>
        <p class="mt-4 text-sm">
         More details for each suppliers will be available in future releases. Such as reports.
        </p>
      <div class="grid grid-cols-1 lg:grid-cols-12 mt-8 mx-5">
        ...
        <div class="col-span-8">
            <input v-model="supplier.name" type="text" class="placeholder-gray-300 dark:placeholder-slate-500 shadow-sm leading-none py-2 focus:ring-highlight focus:border-highlight block w-full sm:text-sm border-gray-300 rounded-md dark:border-slate-500 dark:bg-brand-dark" placeholder="Supplier Name">
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 mt-4 mx-5">
        ...
        <div class="col-span-8">
          <input v-model="supplier.phone" type="text" class="placeholder-gray-300 dark:placeholder-slate-500 shadow-sm leading-none py-2 focus:ring-highlight focus:border-highlight block w-full sm:text-sm border-gray-300 rounded-md dark:border-slate-500 dark:bg-brand-dark" placeholder="Phone">
        </div>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-12 mt-4 mx-5">
        <div class="col-span-4">
        ...
        <div class="col-span-8">
          <input v-model="supplier.email" type="email" class="placeholder-gray-300 dark:placeholder-slate-500 shadow-sm leading-none py-2 focus:ring-highlight focus:border-highlight block w-full sm:text-sm border-gray-300 rounded-md dark:border-slate-500 dark:bg-brand-dark" placeholder="Email address">
        </div>
      </div>
...
export default {
  ...
  const close = () => {
    ...
    return {emit, close,
      ingredients, newIngredient, addIngredients, removeSupplier
    }
  }
}
</script>
